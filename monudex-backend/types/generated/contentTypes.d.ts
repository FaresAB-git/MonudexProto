...
export interface ApiParcoursItemParcoursItem
  ...
  info: {
    displayName: 'parcours_item';
    pluralName: 'parcours-items';
  ...
  attributes: {
    ...
    parcour: Schema.Attribute.Relation<'manyToOne', 'api::parcours.parcours'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    parcours: Schema.Attribute.Relation<'oneToMany', 'api::parcours.parcours'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
